...
DXGI_FORMAT TextureD3D::ToDXGIFormat(ovrTextureFormat format, unsigned int flags)
{
	if (flags & ovrTextureMisc_DX_Typeless)
	{
		switch (format)
		{
			...
			case OVR_FORMAT_B8G8R8_UNORM:         return DXGI_FORMAT_B8G8R8X8_TYPELESS;
			...
			//case OVR_FORMAT_R11G11B10_FLOAT:      return DXGI_FORMAT_R11G11B10_TYPELESS;
	...
	else
	{
		switch (format)
		{
			...
			case OVR_FORMAT_B8G8R8_UNORM:         return DXGI_FORMAT_B8G8R8X8_UNORM;
